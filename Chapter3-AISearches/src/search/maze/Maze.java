//Class Maze represents the search space as a two-dimensional maze
package search.maze;
public class Maze {
...
//The maze (or search space) data is stored as a short integer rather than as a boolean
//Breadth-first style searches can use the array to store search depth.
